...
export default function LoginPage() {
  ...
  const { register, handleSubmit, formState: { isSubmitting } } = useForm<LoginFields>({ defaultValues: { email: "demo@quecocino.app", password: "demo1234" } });
